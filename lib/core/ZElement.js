...
export class ZElement {
    constructor(element, options = {}) {
        ...
        Object.assign(this.glareNode.style, {
            ...
            // FIX: 'screen' ensures glare is visible on black backgrounds (Neon/Metal)
    ...
    updateOptions(options) {
        ...
        this.hasGlare = options.glare !== false; 
    ...
    update(globalMouse) {
        ...
        if (this.hasGlare) {
            ...
            // FIX: Increased opacity to 0.4 for sharper reflection
